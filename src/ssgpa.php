<?php
	...
	{
		$q4="insert into sgpa values('{$_SESSION['ids']}','{$_POST['sem']}','{$_POST['sgpa']}',0)";
		$q5="select * from sgpa where rollno='{$_SESSION['ids']}' and sem='{$_POST['sem']}'";
		$q5r=mysql_query($q5);
...
<!--					<td>Semester</td><td> <input type="text" name="sem" /></td></tr><tr>-->
					...
					<tr>
					<td>sgpa</td><td> <input type="text" name="sgpa"  style="width:60px;"/></td>
					</tr>
